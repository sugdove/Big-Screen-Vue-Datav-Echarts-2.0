<template>
  <div class="col-2">
      ...
      <div class="top-content">
        <div class="main">
          <div style="flex-grow:1;">
               <bottom-right style="width:100%;height:100%;"></bottom-right>
          </div>
        </div>
      </div>
    </div>
    <div class="bottom dv-border-box-6" style="width:50%;float:left">
    ...
    <div class="bottom dv-border-box-6" style="width:50%;float:left">
      <dv-border-box-13 :color="['#146199']">
        <bottom-left2 style="width:100%;height:100%;"></bottom-left2>
      </dv-border-box-13>
    </div>
  </div>
</template>
<script>
import bottomLeft2 from "@/views/bottomLeft2";
import wordCloud from "@/views/word-cloud";
